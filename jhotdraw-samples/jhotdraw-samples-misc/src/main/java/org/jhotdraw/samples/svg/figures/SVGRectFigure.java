...
public class SVGRectFigure extends SVGAttributedFigure implements SVGFigure {
    ...
    @Override
    @FeatureEntryPoint ("setBounds")
    @Tracker(name="setBounds")
    ...
    @FeatureEntryPoint ("invalidateTransformedShape")
    @Tracker(name="invalidateTransformedShape")
    private void invalidateTransformedShape() {
        cachedTransformedShape = null;
        cachedHitShape = null;
    }
    @FeatureEntryPoint ("getTransformedShape")
    @Tracker(name="getTransformedShape")
    ...
    @Override
    @FeatureEntryPoint ("restoreTransformTo")
    ...
    @Override
    @FeatureEntryPoint ("getTransformRestoreData")
    ...
    // EDITING
    @Override
    @FeatureEntryPoint ("createHandles")
